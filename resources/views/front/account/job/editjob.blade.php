                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" value="{{ $job->tittle }}" id="title" name="tittle" class="form-control">
                                    <p></p>
                                </div>
                                    ...
                                    <select name="catagory" id="catagory" class="form-control">
                                        ...
                                        @if ($catagories->isNotEmpty())
                                            @foreach ($catagories as $catagory)
                                                ...
                                                <option value="{{ $catagory->id }}" {{ $job->catagory_id == $catagory->id ? 'selected' : '' }}>{{ $catagory->name }}</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6  mb-4">
                                    ...
                                    <input type="number" min="1" value="{{ $job->vaccency }}" placeholder="Vacancy" id="vacancy" name="vacancy"
                                        class="form-control">
                                        <p></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" value="{{ $job->company_location }}" id="company_location" name="company_location"
                                        class="form-control">
                                        <p></p>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ $job->company_website }}" id="company_website" name="company_website" class="form-control">
                                <p></p>
                            </div>
